...
<body class="">
    ...
    <header id="home" class="text-center py-20 fade-in">
        <div class="container mx-auto">
            ...
            <div class="space-y-8">
                <div>
                    <a href="recept.php" class="bg-teal-600 text-white py-4 px-8 rounded-lg text-xl font-semibold hover:bg-purple-700 transition duration-300 ease-in-out">
                        避難者受付（事前登録済みの方）
                    </a>
                </div>
                <div>
                    <a href="regist.php" class="bg-purple-600 text-white py-4 px-8 rounded-lg text-xl font-semibold hover:bg-purple-700 transition duration-300 ease-in-out">
                        避難者受付（事前登録済みでない方）
                    </a>
                </div>
            </div>
